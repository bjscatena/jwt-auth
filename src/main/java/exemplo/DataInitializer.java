...
import exemplo.repository.UserRepository;
import exemplo.repository.VehicleRepository;
...
public class DataInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Arrays.asList("moto", "car").forEach(v -> this.vehicles.save(Vehicle.builder().name(v).build()));
